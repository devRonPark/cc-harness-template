...
> 보류(YAGNI) — 현재 task-decomposer·test-agent는 `tasks/index.json`·Plans.md·CLAUDE.md를
...
1. 분해 결과를 `tasks/index.json` Task 객체(section/id/title/dod/acceptance/depends)로 기록하고 `scripts/sync_plans.py`로 `Plans.md` 재생성
