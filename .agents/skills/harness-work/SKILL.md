...
5. 기준 통과 시 `.harness/tasks/<task-key>/STATE.md`를 갱신하고 구현한다. Task 디렉토리가 없으면 루트 템플릿 중 `STATE.md`, `LOG.md`, `RUN_REPORT.md` 3종만 복사해 만든다. `HANDOFF.md`, `TASKS.md`, `CHECKPOINTS.md`는 실제로 필요해질 때만 추가한다.
